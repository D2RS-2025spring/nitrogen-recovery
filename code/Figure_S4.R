...
malit<- readxl::read_xlsx('D:/coursework/tang/小组作业/Source Data.xlsx',sheet = "FigureS4")
...
gg <- ggdraw() +     
  ...
  draw_plot_label(c("a", "b", "c"), c(0, 0, 0.6), c(1, 0.5, 0.5), size = 28, colour = "black", family = "serif") 
showtext_begin()
print(gg)
showtext_end()

ggsave(file = "D:/coursework/tang/小组作业/picture/Figure_S4.png",width = 410,height = 310, units = "mm")