...
# --- ROM Method -----
d1 <- readxl::read_xlsx('Source Data.xlsx',sheet ="Figure3a")
d1 <- as.data.table(d1)
...
# ---  MD Method ----
d2 <- readxl::read_xlsx('Source Data.xlsx',sheet ="Figure3b")
d2 <- as.data.table(d2)
...
# --- SMD Method -----
d3 <- readxl::read_xlsx('Source Data.xlsx',sheet ="Figure3c")
d3 <- as.data.table(d3)
