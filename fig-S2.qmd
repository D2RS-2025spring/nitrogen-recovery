...
library(data.table); library(gridExtra); library(cowplot); library(ggplot2)

# load the data file
d1 <- readxl::read_xlsx('Source Data.xlsx',sheet = "FigureS2")
d1 <- as.data.table(d1)
...
ggsave(file = "picture/Figure_S2.png",width = 410,height = 297, units = "mm")
