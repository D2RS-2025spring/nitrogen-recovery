...
# derive the meta-analytical model
    ...
    # read data  
    d1 <- readxl::read_xlsx('Source Data.xlsx',sheet = "FigureS5")
    d1 <- as.data.table(d1)
    ...
    # write as output
    terra::writeRaster(r.fin,'tif/scenario_SI0.tif', overwrite = TRUE)
    ...
    # write as output
    terra::writeRaster(r.fin,'tif/scenario_SI1.tif', overwrite = TRUE)
    ...
    # write as output
    terra::writeRaster(r.fin,'tif/scenario_SI2.tif', overwrite = TRUE)
    ...
    # write as output
    terra::writeRaster(r.fin,'tif/scenario_SI3.tif', overwrite = TRUE)
    ...
    # write as output
    terra::writeRaster(r.fin,'tif/scenario_SI4.tif', overwrite = TRUE)
    ...
    # write as output
    terra::writeRaster(r.fin,'tif/scenario_SI5.tif', overwrite = TRUE)
    ...
    # write as output
    terra::writeRaster(r.fin,'tif/scenario_SI7.tif', overwrite = TRUE)
    ...
    # write as output
    terra::writeRaster(r.fin,'tif/scenario_SI8.tif', overwrite = TRUE)
    ...
    # write as output
    terra::writeRaster(r.fin,'tif/scenario_4.tif', overwrite = TRUE)   
...
###############################################################################################################################
    ...
    r10 <- terra::rast('tif/scenario_SI0.tif')
    ...
    # get the raster to plot
    r11 <- terra::rast('tif/scenario_SI1.tif')
    ...
    # get the raster to plot
    r12 <- terra::rast('tif/scenario_SI2.tif')
    ...
    # get the raster to plot
    r13 <- terra::rast('tif/scenario_SI3.tif')
    ...
    # get the raster to plot
    r14 <- terra::rast('tif/scenario_SI4.tif')
    ...
    # get the raster to plot
    r15 <- terra::rast('tif/scenario_SI5.tif')
    ...
    # get the raster to plot
    r17 <- terra::rast('tif/scenario_SI7.tif')
    ...
    # get the raster to plot
    r18 <- terra::rast('tif/scenario_SI8.tif')
    ...
    ggsave(p_S5, file = "picture/Figure_S5.png",width = 410,height = 197, units = "mm")
    ...
    # get the raster to plot
    r4 <- terra::rast('tif/scenario_4.tif')
...
#| fig-asp: 1.5   
    ...
    ggsave(p, file = "picture/Figure_4.png",width = 410,height = 197, units = "mm")
